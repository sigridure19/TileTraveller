...
def box_1_1():
    ...
    # breytum strengnum í lower því notandi má gera upper eða lower
    if direction_str == "n":
        return box_1_2()
    else:
        print("Not a valid direction!")
        return box_1_1() # byrjum aftur í sama falli ef það er invalid input
...
start_box = box_1_1() #köllum bara á byrjunarreitinn.